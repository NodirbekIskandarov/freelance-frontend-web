        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-5 lg:gap-3 xl:gap-4">
          {services.map((service, index) => (
            <div
              key={index}
              className={cn(
                'group hover: relative flex flex-col overflow-hidden rounded-2xl border bg-gradient-to-br p-4 transition-all duration-300 hover:-translate-y-1 sm:p-5',
                service.theme.card,
              )}
            >
              <div
              ...
              <div className="relative flex items-start justify-between gap-2">
                <div
                  className={cn(
                    'grid size-11 place-items-center rounded-xl bg-gradient-to-br text-white transition-transform duration-300 group-hover:scale-105',
                    service.theme.icon,
                  )}
                >
