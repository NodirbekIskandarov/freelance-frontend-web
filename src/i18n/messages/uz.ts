...
export const uz = {
  ...
  home: {
    ...
    servicesTitle: 'Nima kerak bo\u2018lsa — bor',
    service1: 'Tayyor topshiriqlar',
    service1Desc: "Amaliy, laboratoriya va mustaqil ishlar — variant bo'yicha tayyor yechim.",
    service2: 'Konspekt',
    service2Desc:
      "Qo'lda yozilgan konspekt xizmati — sizning daftaringiz, sizning qo'l yozuvingiz.",
    service3: 'Chizmachilik',
    service3Desc: 'AutoCAD, arxitektura va muhandislik chizmalari — chizma va DWG fayl.',
    service4: 'Spravka',
    service4Desc: 'Talaba va shifokorlar uchun rasmiy spravkalar tayyorlash.',
    service5: 'Diplom ishlari',
    service5Desc: "Bitiruv va malakaviy ishlar — bo'limlar bo'yicha bosqichma-bosqich.",
    ...
    servicesLead: 'Tayyor material yoki mutaxassis — ikkalasi ham bitta platformada.',
    servicePrice: 'Narx',
    serviceReadyCount: '{count} ta',
    service1Price: "7 000 so'mdan",
    service2Price: "1 500 so'm / bet",
    service3Price: "25 000 so'mdan",
    service4Price: 'kelishuv asosida',
    service5Price: "800 000 so'mdan",
    rewardSellingShare: '75%',
    rewardSubjectAmount: '15 000',
    rewardAssignmentAmount: '8 000',
    rewardReferral: "Do'st taklif qilish",
    rewardReferralNote: "birinchi xaridi bo'lganda",
  ...
  purchase: {
    ...
    author: 'Muallif: {name}',
    footnote:
      "Fayl darhol «Kutubxonam» bo'limiga tushadi va cheksiz marta yuklab olinadi. Fayl mos kelmasa kafolat muddati ichida shikoyat qilib pulni qaytarish mumkin.",
  ...
  appeals: {
    ...
    modalLead:
      "Operator ish vaqtida ko'rib chiqadi — javob profilingizdagi «Murojaatlarim» bo'limida chiqadi.",
    describe: 'Muammoni tasvirlab bering',
    describePlaceholder:
      'Masalan: 7-variant deb sotib oldim, lekin faylda 12-variant sohasi chiqdi…',
    describeHint: 'Aniq yozganingiz javobni tezlashtiradi: sana, variant raqami, xato matni.',
    attach: 'Fayl biriktirish',
    attachAction: 'Skrinshot yoki faylni tanlang',
    attachHint: 'PNG, JPG yoki PDF · 10 MB gacha · {limit} tagacha',
    removeFile: 'Faylni olib tashlash',
    fileTooBig: '«{name}» juda katta — 10 MB gacha fayl biriktiring.',
    sentTitle: 'Murojaat yuborildi',
    sentText: 'Murojaat {reference} raqami bilan saqlandi. Javob kelganda xabar beramiz.',
    myAppeals: 'Murojaatlarim',
    loginRequired:
      "Murojaat qoldirish uchun avval hisobingizga kiring — javobni o'sha yerdan olasiz.",
  },

  help: {
    breadcrumb: 'Yordam markazi',
    shortcutRefund: 'Pulni qaytarish',
    shortcutRefundNote: 'Shikoyat va kafolat',
    shortcutUpload: 'Yechim yuklash',
    shortcutUploadNote: 'Moderatsiya qoidalari',
    shortcutBalance: "Balansni to'ldirish",
    shortcutBalanceNote: "To'lov usullari",
    shortcutWithdraw: 'Daromadni yechish',
    shortcutWithdrawNote: 'Muddat va summa',
    popularRefund: 'pulni qaytarish',
    popularBalance: 'balans',
    popularUpload: 'yechim yuklash',
    popularVariant: 'variant',
    popularWithdraw: 'yechib olish',
    heading: 'Qanday yordam kerak?',
    lead: "Savolingizni yozing yoki bo'limlardan tanlang. Javob topilmasa — operatorga murojaat qoldiring.",
    searchLabel: 'Yordam bo\u2018yicha qidiruv',
    searchPlaceholder: 'Masalan: pulni qanday qaytaraman?',
    popular: "Ko'p so'raladi:",
    sectionsLabel: "Bo'limlar",
    searchResults: 'Qidiruv natijalari',
    searchCount: '{count} ta javob topildi',
    expandAll: 'Hammasini ochish',
    collapseAll: 'Hammasini yopish',
    helpful: 'Javob yordam berdimi?',
    thanks: 'Rahmat!',
    askOperator: 'Operatorga yozish',
    nothingFound: 'Bunday savol topilmadi',
    nothingFoundLead:
      "Boshqacha so'z bilan qidirib ko'ring yoki to'g'ridan-to'g'ri operatorga yozing.",
    operatorsTitle: 'Operatorlar',
    operatorsHours:
      'Har kuni {hours}. Ish vaqtidan tashqarida yozsangiz ham murojaat navbatga tushadi.',
    writeToOperator: 'Murojaat yuborish',
    stillStuck: 'Javob topilmadimi?',
    stillStuckLead:
      "Savolingizni yozib qoldiring — operator javob beradi, savol tez-tez berilsa shu bo'limga qo'shiladi.",
    contactsTitle: 'Aloqa',
    contactsLead: "Qaysi kanal qulay bo'lsa — o'shanisi orqali yozing.",
    contactTelegram: 'Telegram',
    contactTelegramNote: 'Eng tez kanal',
    contactEmail: 'Email',
    contactEmailNote: 'Hujjat va uzun savollar uchun',
    contactPhone: 'Telefon',
    contactPhoneNote: 'Ish kunlari',
    contactAddress: 'Manzil',
    contactAddressNote: 'Faqat oldindan kelishilgan holda',
    days: '{count} kun',
    hours: '{count} soat',
    rewardClause: ' — tasdiqlansa hisobingizga {amount} tushadi',
    rewardSubject: 'yangi fan',
    rewardAssignment: 'topshiriq',
    rewardUniversity: 'institut',
    rewardsOn: 'Tasdiqlangan ariza uchun mukofot to\u2018lanadi: {list}.',
    rewardsOff: "Tasdiqlangan ariza katalogga qo'shiladi va profilingizda ko'rinadi.",
  },
